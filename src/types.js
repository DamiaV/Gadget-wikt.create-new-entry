...
const icons = {
  ...
  // Rescaled to 20×20 px viewbox from https://commons.wikimedia.org/wiki/File:Vikidia_V_vectorised.svg
  vikidia:
  ...
  // Rescaled to 20×20 px viewbox from https://commons.wikimedia.org/wiki/File:Le_Dico_des_Adps_small_logo_2021_dark_background.svg
  dicoado:
